# -*- coding: utf-8 -*-
"""Task_3_Model_A.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dg6mWS02xOJlU15RGjoQJN2eFlE-uh_V
...
#### There are 2 cells for Model_A that are given below.
...
checkpoint = torch.load('gdrive/MyDrive/trained-model_A-model.ckpt')
model_A.load_state_dict(checkpoint['model_state_dict'])
optimizer_model_A.load_state_dict(checkpoint['optimizer_state_dict'])
